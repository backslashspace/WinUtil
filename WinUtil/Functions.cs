...
namespace WinUtil
{
    public class Functions : MainWindow
    {
        ...
        public static void NotepadPlusPlus()
        {
            ...
            else
            {
                if (WinGetIsInstalled(true) == 1)
                {
                    ...
                    {
                        Start("winget.exe", "install notepad++ --accept-source-agreements --scope machine", true, true);
        ...
        public static void RMOneDrive()
        {
            ...
            {
                Write("\nNo OneDrive installation detected, skipping\n\n", "darkyellow", null);
            }
        ...
        public static void Zip7()
        {
            ...
            if (CompareHash256("assets\\" + Const.zip7installName, Const.zip7installHash, true)[0] == 1)
            {
                ...
                InternExtract("C:\\Program Files\\7-Zip\\assets\\Codecs\\", "WinCryptHashers.64.dll", "_7zip.WinCryptHashers.64.dll");
                InternExtract("C:\\Program Files\\7-Zip\\assets\\Codecs\\", "WinCryptHashers.ini", "_7zip.WinCryptHashers.ini");
